                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group input-group-sm">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" wire:model="description" cols="10" id="editor1" name="description" rows="5" autofocus></textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
