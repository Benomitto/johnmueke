                        ...
                        <div class="row">
							...
							<div class="col-lg-4">
                                <div class="form-group ">
                                    ...
                                    <input class=" @error('photo') is-invalid @enderror" type="file" value="{{ old('photo')}}" wire:model="photo" autofocus>
                                    @error('photo')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group input-group-sm">
                                    ...
                                    <div id="summernote"><textarea class="form-control @error('description') is-invalid @enderror" 
