    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    <form autocomplete="off" enctype="multipart/form-data" action="#" method="">
					@csrf
                        <div class="mt-10">
                            <input type="text" class="bg-light form-control mb-2" name="shoutout_title" placeholder="Please Enter your request Title:"
                        ...
                        <div class="mt-10 input-group-icon">
                            <div class="icon"></div>
                            <input type="text" class="bg-light form-control mt-2 mb-2" name="name" placeholder="Your Name"
                                wire:model="name"
                        ...
                        <div class="mt-10 input-group-icon">
                            <div class="icon"></div>
                            <input type="email" class="bg-light form-control mt-2 mb-2" name="email" placeholder="Your Email"
                                wire:model="email"
                        ...
                        <div class="mt-10 input-group-icon">
                            <div class="icon"></div>
                            <input type="text" class="bg-light form-control mb-2" name="phone" placeholder="Your phone"
                                wire:model="phone"
                        ...
                        <div class="mt-10">
                            <textarea class="single-textarea bg-light form-control mb-2" name="description" placeholder="Message" onfocus="this.placeholder = ''"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger genric-btn danger small" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>