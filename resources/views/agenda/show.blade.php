   ...
   <div class="container-xl mt-5 mb-5">
	<div class="row g-4">
		<div class="col-md-8 mx-auto">
			<p class="text-center my-5 text-dark fw-bold fs-3 mt-5" id="section-1"><br>{{$agenda->agenda_title}}</p>

			<img src="{{ asset('storage/'.$agenda->photo) }}" class="float-center rounded img-fluid ms-5">
