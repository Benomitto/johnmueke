	...
	<div class="container mt-5">
		...
		@foreach($data as $aboutus)
			<div class="col-lg">
				...
				<p class="fs-6 text-lg-start"> {{Str::limit($aboutus->description,50)}}</p>
	...
	@foreach($SocialMedia as $social_media)
		<div class="row">
			<div class="col-md-6 col-sm-12">
					...
					<p class="text-warning fw-bold mt-5" id="agenda"><a href="posts" class="text-decoration-none text-warning">{{$social_media->learn}}</a></p>
			</div>
			<div class="col-md-6 col-sm-12" >
            ...
            <div class="row">
			   ...
			   <div class="col-md-4 text-start">
                    ...
                    <div class="feature-content">
						...
						<p class="text-justify text-md-start" style="color:#666;font-weight:400;font-size:14px;">{{Str::limit($agenda->description,153)}}</p>
				   </div>
                </div>
				@endforeach
            </div>
