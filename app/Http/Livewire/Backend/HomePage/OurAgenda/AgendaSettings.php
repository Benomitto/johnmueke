...
{
    use WithFileUploads;
    public $agenda_title,$cover_image,$description, $photo, $agenda_id;
    ...
    public function store()
    {
        ...
        Agenda::create([
			...
			'photo' => $this->photo->store('album','public'),
    ...
    public function edit($id)
    {
		...
		$this->photo = $findAgendaById->photo;
    }   
    ...
    public function updateImage()
    {
        if($this->agenda_id)
        {
			...
			$filename = $this->photo->store('album','public');
